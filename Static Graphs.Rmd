...
nixon.pid <- ggplot()  +  
  ...
  ggtitle("Nixon")  + xlab("Year") + ylab("Approval rating by\n party identification") + 
  scale_y_continuous(limits = c(0,100)) + annotate(data = nixon, "text", x=as.POSIXct("1974-03-06 UTC"), y=75, label="House Judiciary Committee\n investigation and hearings", size=2.5) + 
  mytheme  + 
...
clinton.pid <- ggplot() + 
  ...
  ggtitle("Clinton")  + xlab("Year") + ylab("Approval rating by\n party identification") + 
  scale_y_continuous(limits = c(0,100)) +  
  annotate(data = Capp.pid, "text",x=as.POSIXct("1999-01-06"), y=99, label="Impeachment deliberation\n and Senate trial") + 
  mytheme +   
  scale_color_manual(values = c(Democrats=ussc_darkBlue, Republicans=ussc_red, Independents ='black')) + 
  theme(legend.title=element_blank(), legend.position = "bottom")
...
Trump.partyID <- ggplot() +  
  ...
  ggtitle("Trump") + xlab("Month") + ylab("Approval rating by\n party identification") + 
...
ggsave("partyID.jpg", a, width=6, height=8)
```
