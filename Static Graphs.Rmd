...
Trump_app <- app.pid %>%
  slice(119:141)
ggplot(app.pid) + geom_line(aes(x=dop, y=inparty_app, group=presName)) + geom_line(data=Trump_app, (aes(x=dop, y=inparty_app, size=10, color=ussc_red))) + xlab("Month") + ylab("In party approval rating") + theme(legend.position = "none") + ggtitle("Trump approval among in-party partisans, compared with Eisenhower \nto Obama.")
```
